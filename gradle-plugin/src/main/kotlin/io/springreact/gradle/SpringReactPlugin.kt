...
/**
 * Apply with `plugins { id("io.springreact") version "0.1.0" }` and your build is ready to
...
class SpringReactPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        project.afterEvaluate {
            ...
            project.dependencies.add("implementation", "io.springreact:SpringReact:${ext.version.get()}")
        }
    }
